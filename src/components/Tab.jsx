...
export default function Tab({ title, active, onClick, close }) {
    ...
    return (
        <div draggable onClick={onClick} className={cls("gap-5 flex items-center border-[1px] dark:border-zinc-800 rounded-sm px-3 py-1 cursor-pointer select-none", active && "bg-zinc-300 dark:bg-zinc-800")}>
