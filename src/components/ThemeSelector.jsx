...
export default function ThemeSelector({ setTheme }) {
    ...
    return (
        <div className="dark:border-zinc-700 border-zinc-300 shadow-md border-[1px] rounded-lg my-2 pr-3 pl-5 py-4 w-fit">
				<form onChange={changeTheme} className="text-base">
